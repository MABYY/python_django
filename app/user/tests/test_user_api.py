...
#         create_user(email='test@example.com', name='Test User' ,password='goodpass')
#         payload = { 'email': 'test@example.com','name':'Test User','password': 'badpass'}
...
#         '''Test wuthentification is required for users.'''
#         res = self.client.get(ME_URL)
#         # You cannot access the endpoint if you are not authenticated   
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):        
        ...
        self.client.force_authenticate(user=self.user) ## force authentization 
    
    def test_retrieve_profile_success(self):
        '''Test receiving prifile for logged in user.'''
        res= self.client.get(ME_URL)
